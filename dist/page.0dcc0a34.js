...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/page/index.js":[function(require,module,exports) {
"use strict";
...
_axios.default.get('https://jsonplaceholder.typicode.com/posts').then(function (response) {
  ...
  var paginatedResponseData = response.data.slice("".concat(page - 1, "0"), "".concat(page, "0")); // call view function
